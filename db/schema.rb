...
ActiveRecord::Schema[7.0].define(version: 2023_07_17_080629) do
  ...
  create_table "protospaces", charset: "utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_protospaces_on_user_id"
  end
